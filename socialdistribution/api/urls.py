...
urlpatterns = [
    ...
    path('authors/<str:author_id>/posts/<str:post_id>/likes', views.LikesOnPost.as_view(), name='liked-list'),
    path('authors/<str:author_id>/posts/<str:post_id>/comments/<str:comment_id>/likes', views.LikesOnComment.as_view(), name='liked-list'),
